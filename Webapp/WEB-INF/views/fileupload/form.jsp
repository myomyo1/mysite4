					...
					<c:forEach items="${flist}" var="f" varStatus="status">
						<ul>
							<li>
								<table>
									<tr>
										<td><img src="${pageContext.request.contextPath }/upload/${f.saveName}" style="width:150px"><br></td>
										<td><a href="${pageContext.request.contextPath }/fileupload/delete?no=${f.no}">삭제</a></td>
									</tr>
								</table> <br>
							</li>
						</ul>
